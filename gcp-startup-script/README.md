...
- https://github.com/DimitryZH/emp-app/tree/main/GCP

## Repository Context

This startup script is also included as a module in the Bash Automation Scripts Collection. For an overview of other modules and contribution guidelines, see the root [`README.md`](../README.md).
